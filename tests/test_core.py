...
def test_tformula():
    ...
    # FIXME 1.0111198935028287 != 0.9954776655511116
    # assert evaluate("[2]*([3]*([4]+[5]*log(max([0],min([1],x))))*1./([6]+[7]*100./3.*(max(0.,1.03091-0.051154*pow(x,-0.154227))-max(0.,1.03091-0.051154*pow(208.,-0.154227)))+[8]*((1+0.04432-1.304*pow(max(30.,min(6500.,x)),-0.4624)+(0+1.724*log(max(30.,min(6500.,x))))/max(30.,min(6500.,x)))-(1+0.04432-1.304*pow(208.,-0.4624)+(0+1.724*log(208.))/208.))))", [100.], v) == v[2] * (v[3] * (v[4] + v[5] * math.log(max(v[0], min(v[1], x)))) * 1. / (v[6] + v[7] * 100. / 3. * (max(0., 1.03091 - 0.051154 * math.pow(x, -0.154227)) - max(0., 1.03091 - 0.051154 * math.pow(208., -0.154227))) + v[8] * ((1 + 0.04432 - 1.304 * math.pow(max(30., min(6500., x)), -0.4624) + (0 + 1.724 * math.log(max(30., min(6500., x)))) / max(30., min(6500., x))) - (1 + 0.04432 - 1.304 * math.pow(208., -0.4624) + (0 + 1.724 * math.log(208.)) / 208.))))
